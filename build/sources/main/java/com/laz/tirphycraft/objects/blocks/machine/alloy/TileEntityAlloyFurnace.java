...
public class TileEntityAlloyFurnace extends TileEntity implements IInventory, ITickable {
	...
	private boolean canSmelt( ) {
		if (((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty()) return false;
			...
			ItemStack result = AlloyFurnaceRecipes.getInstance().getAlloyResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
	...
	public String getGuiID() {
		return "tirphycraft:alloy_furnace";
	}
