package com.laz.tirphycraft.objects.blocks.customModel.vine;
...
public class CaveVines extends BlockBase implements net.minecraftforge.common.IShearable, IHasModel
{
    ...
    public CaveVines()
    {
        super("cave_vines", Material.VINE, 0.2F, 1, "shears", 0, SoundType.PLANT);
