...
public class BlockLeavesFroz extends BlockLeaves implements IHasModel
{		
	public static String type;
	
	public BlockLeavesFroz(String name) 
	{
	...
	{
		return Item.getItemFromBlock(BlockInit.SAPLING_FROZ);
