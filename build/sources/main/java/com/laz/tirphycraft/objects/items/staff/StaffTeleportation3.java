...
public class StaffTeleportation3 extends Item implements IHasModel {
	public StaffTeleportation3(String name) {
		{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add("\u00A74" + "teleport 20 blocks");
		tooltip.add("");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		double x = (playerIn.posX + aim.x * 20);
		double y = (playerIn.posY + aim.y * 20);
		double z = (playerIn.posZ + aim.z * 20);
