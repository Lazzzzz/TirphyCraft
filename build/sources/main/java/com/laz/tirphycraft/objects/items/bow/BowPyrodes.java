...
public class BowPyrodes extends ItemBow implements IHasModel {

	public BowPyrodes(String name, float speed, boolean fire) {
		...
		this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
			...
			public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
				if (entityIn == null) {
					...
					return entityIn.getActiveItemStack().getItem() != ItemInit.BOW_PYRODES ? 0.0F
