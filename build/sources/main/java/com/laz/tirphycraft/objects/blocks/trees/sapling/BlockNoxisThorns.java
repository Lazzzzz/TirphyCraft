...
public class BlockNoxisThorns extends BlockBush implements IHasModel {
	...
	public BlockNoxisThorns() {
		setUnlocalizedName("noxis_thorns");
		setRegistryName("noxis_thorns");
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		return soil == BlockInit.NOXIS_STONE.getDefaultState();
	}
