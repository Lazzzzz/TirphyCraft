...
public class StaffExplosion3 extends Item implements IHasModel {
	public StaffExplosion3(String name) {
		{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			...
			EntityTNTPrimed tnt3 = new EntityTNTPrimed(worldIn, x, y, z, playerIn);
			...
			tnt3.motionX = aim.x * 1.5D;
			tnt3.motionY = aim.y * 0.5D;
			tnt3.motionZ = aim.z * 1.5D;

			worldIn.spawnEntity(tnt);
			worldIn.spawnEntity(tnt2);
			worldIn.spawnEntity(tnt3);
