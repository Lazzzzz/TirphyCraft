...
public class StaffFireBall3 extends Item implements IHasModel {
	public StaffFireBall3(String name) {
		{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (playerIn instanceof EntityPlayer) {
			((EntityPlayer) playerIn).getCooldownTracker().setCooldown(this, 4);
		}
