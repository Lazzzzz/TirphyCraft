...
public class StaffTeleportation2 extends Item implements IHasModel {
	public StaffTeleportation2(String name) {
		{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add("\u00A74" + "teleport 15 blocks");
		tooltip.add("");
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		double x = (playerIn.posX + aim.x * 15);
		double y = (playerIn.posY + aim.y * 15);
		double z = (playerIn.posZ + aim.z * 15);
