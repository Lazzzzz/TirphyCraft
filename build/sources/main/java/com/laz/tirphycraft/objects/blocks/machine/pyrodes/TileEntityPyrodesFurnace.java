...
public class TileEntityPyrodesFurnace extends TileEntity implements IInventory, ITickable {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.pyrodes_furnace";
	}
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockPyrodesFurnace.setState(this.isBurning(), this.world, this.pos);
			}
	...
	private boolean canSmelt( ) {
		if (((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty()) return false;
			...
			ItemStack result = PyrodesFurnaceRecipes.getInstance().getPyrodesResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
	...
	public void smeltItem( ) {
		if (this.canSmelt()) {
			...
			ItemStack result = PyrodesFurnaceRecipes.getInstance().getPyrodesResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public static int getItemBurnTime(ItemStack fuel) {
		if(fuel.isEmpty()) return 0;
			...
			if (item == ItemInit.COAL_ON_COKE) return 400;
			if (item ==	Item.getItemFromBlock(BlockInit.BLOCK_COAL)) return 3600;
