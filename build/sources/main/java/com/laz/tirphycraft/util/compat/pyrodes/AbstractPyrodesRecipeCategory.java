...
public abstract class AbstractPyrodesRecipeCategory <T extends IRecipeWrapper> implements IRecipeCategory<T>{

	protected static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/pyrodes_furnace.png");
	...
	public AbstractPyrodesRecipeCategory(IGuiHelper helper) {
