...
public class worldGenPurpleTree extends WorldGenTrees {

	public static final IBlockState LOG = Blocks.LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_PURPLE.getDefaultState();
	
	public worldGenPurpleTree() {
