...
public class WorldGenCrystalPick extends WorldGenerator
{
                ...
                for (int i1 = -l; i1 <= l; ++i1)
                {
                    ...
                    for (int j1 = -l; j1 <= l; ++j1)
                    {
                        ...
                        if ((i1 == 0 && j1 == 0 || f1 * f1 + f2 * f2 <= f * f) && (i1 != -l && i1 != l && j1 != -l && j1 != l || rand.nextFloat() <= 0.75F))
                        {
                            ...
                            if (iblockstate.getBlock().isAir(iblockstate, worldIn, position.add(i1, k, j1)) || block == BlockInit.FROZ_STONE)
                            {
                                this.setBlockAndNotifyAdequately(worldIn, position.add(i1, k, j1), BlockInit.BLACK_CRYSTAL.getDefaultState());
                            }
