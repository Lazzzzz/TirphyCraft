...
public class ArmorInit {
	...
	public static final ArmorMaterial ORIGIN_ARMOR    = EnumHelper.addArmorMaterial("origin_armor", Reference.MOD_ID + ":origin", 70, new int[] {8, 11, 12, 8}, 40, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 7.0F);
