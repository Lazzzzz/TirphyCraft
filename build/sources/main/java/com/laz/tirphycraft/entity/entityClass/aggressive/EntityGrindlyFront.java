...
public class EntityGrindlyFront extends EntityMob {
	public EntityGrindlyFront(World worldIn) {
	...
	protected ResourceLocation getLootTable() {
		return LootTableHandler.GRINDLYFRONT_LOOT;
	}
	...
	public boolean attackEntityAsMob(Entity entityIn) {
		...
		entityIn.motionX = 4D * view.x;	
		entityIn.motionY = .5D * view.y;
		entityIn.motionZ = 4D * view.z;		
