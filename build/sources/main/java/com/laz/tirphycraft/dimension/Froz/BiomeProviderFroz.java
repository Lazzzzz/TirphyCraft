...
public class BiomeProviderFroz extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderFroz() {
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderFroz(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerFixFroz.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderFroz(World world) {
		this(world.getSeed());
	}
