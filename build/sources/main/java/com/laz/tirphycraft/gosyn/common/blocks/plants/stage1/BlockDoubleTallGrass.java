package com.laz.tirphycraft.gosyn.common.blocks.plants.stage1;
...
public class BlockDoubleTallGrass extends BlockBush implements IHasModel {
	protected static final PropertyEnum<BlockDoublePlant.EnumBlockHalf> HALF = BlockDoublePlant.HALF;

	public BlockDoubleTallGrass() {
		super(Material.VINE);
		setUnlocalizedName("double_tall_grass");
		setRegistryName("double_tall_grass");
	...
	public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
		if (state == BlockInit.DOUBLE_GRASS.getDefaultState()) {
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		return soil == BlockInit.GRASS.getDefaultState() || soil == BlockInit.DIRTY_GRASS.getDefaultState();
	}
	...
	public boolean canBlockStay(World world, BlockPos pos, IBlockState state) {
		...
		if (state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER) {
			...
			return world.getBlockState(pos.down()) == BlockInit.GRASS.getDefaultState()
					|| world.getBlockState(pos.down()) == BlockInit.DIRTY_GRASS.getDefaultState();
		}
	}
