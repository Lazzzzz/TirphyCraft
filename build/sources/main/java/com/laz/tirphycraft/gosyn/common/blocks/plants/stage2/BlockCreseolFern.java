...
public class BlockCreseolFern extends BlockBush implements IHasModel {
	...
	public BlockCreseolFern() {
		setUnlocalizedName("creseol_fern");
		setRegistryName("creseol_fern");
