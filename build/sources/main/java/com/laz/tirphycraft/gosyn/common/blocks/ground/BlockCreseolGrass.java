...
public class BlockCreseolGrass extends Block implements IHasModel{

	public BlockCreseolGrass() {
		super(Material.GRASS);
		setUnlocalizedName("creseol_grass");
		setRegistryName("creseol_grass");
