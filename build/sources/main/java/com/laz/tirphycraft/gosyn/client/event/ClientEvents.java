package com.laz.tirphycraft.gosyn.client.event;
...
public class ClientEvents {
	...
	public static void texStitch(TextureStitchEvent.Pre event) {
		...
		map.registerSprite(new ResourceLocation(Reference.MOD_ID, "particle/particle_vortex"));
		map.registerSprite(new ResourceLocation(Reference.MOD_ID, "particle/particle_falling_leaf"));
	}
