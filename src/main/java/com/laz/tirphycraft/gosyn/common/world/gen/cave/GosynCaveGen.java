package com.laz.tirphycraft.gosyn.common.world.gen.cave;
...
public class GosynCaveGen extends MapGenBase
{
    ...
    {
        if (p_175793_1_.getBlock() == BlockInit.ROCK)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlockInit.DIRT)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlockInit.DIRTY_GRASS)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlockInit.GRASS)
        {
            return true;
        }
