...
public class BlockMudShortGrass extends BlockBush implements IHasModel {
	...
	public BlockMudShortGrass() {
		setUnlocalizedName("mud_shortgrass");
		setRegistryName("mud_shortgrass");
