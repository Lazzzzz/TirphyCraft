package com.laz.tirphycraft.gosyn.common.blocks.plants.stage2;
...
public class BlockCreseolSmallGrass extends BlockBush implements IHasModel {
	...
	public BlockCreseolSmallGrass() {
		setUnlocalizedName("creseol_smallgrass");
		setRegistryName("creseol_smallgrass");
