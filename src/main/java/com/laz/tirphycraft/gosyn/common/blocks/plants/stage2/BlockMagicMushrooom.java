...
public class BlockMagicMushrooom extends BlockBush implements IHasModel {
	...
	public BlockMagicMushrooom() {
		setUnlocalizedName("magic_mushrooom");
		setRegistryName("magic_mushrooom");
