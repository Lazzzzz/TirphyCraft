package com.laz.tirphycraft.objects.portal.gosyn;
...
public class BlockGosynPortalNull extends Block {

	public BlockGosynPortalNull() {
		super(Material.AIR);
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		...
		if (entityIn instanceof EntityPlayerMP && entityIn.dimension != ConfigHandler.DIMENSION_GOSYN_ID) {
			...
			if (minecraftserver != null) {
				minecraftserver.getCommandManager().executeCommand((EntityPlayerMP) entityIn, "TP " + ConfigHandler.DIMENSION_GOSYN_ID);
