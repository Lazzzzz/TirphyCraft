...
public class StaffHeal3 extends Item implements IHasModel{
	public StaffHeal3(String name) {
		{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (playerIn.getHealth() <  playerIn.getMaxHealth()) {
			playerIn.addPotionEffect(new PotionEffect(MobEffects.INSTANT_HEALTH, 1, 2, false, false));
