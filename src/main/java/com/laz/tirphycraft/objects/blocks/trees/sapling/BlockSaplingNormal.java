...
public class BlockSaplingNormal extends BlockBush implements IGrowable, IHasModel {
	...
	public BlockSaplingNormal(String name) {
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state) {
		...
		case "SELF":
			...
			if (o==0) gen = new worldGenBlueTree();
			else if (o==1) gen = new worldGenGreenTree();
			else if (o==2) gen = new worldGenWhiteTree();
			else if (o==3) gen = new worldGenPurpleTree();
			break;
		}
