...
public class BlockLeavesGoldir extends BlockLeaves implements IHasModel
{		
	public static String type;
	
	public BlockLeavesGoldir(String name) 
	{
	...
	{
		return Item.getItemFromBlock(BlockInit.SAPLING_GOLDIR);
