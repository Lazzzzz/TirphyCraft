package com.laz.tirphycraft.objects.blocks.customBlock.bush;
...
public class BlockBushGreen extends BlockBase {

	public BlockBushGreen(String name, Material material, float hard, float resist, String type, int i, SoundType sound) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(),
					new ItemStack(ItemInit.FRUIT_BALL_GREEN, new Random().nextInt(2) + 1)));
