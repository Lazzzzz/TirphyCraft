...
public class BlockPurpleCrystalFull extends BlockCrystalFullBase {

	public BlockPurpleCrystalFull() {
		super("laputa_purple", Material.GLASS, 2, 2, "pickaxe", 0, SoundType.GLASS, 0.3F);
	}
	...
	private void spawnParticles(World worldIn, BlockPos pos) {
		...
		if (random.nextInt(3) == 0) {
			...
			Reference.PROXY.spawnParticle(worldIn, ParticleTypes.GLINT_PURPLE, d0, d1, d2, 0.0D, 0.01D, 0.0D);
		}
	}
