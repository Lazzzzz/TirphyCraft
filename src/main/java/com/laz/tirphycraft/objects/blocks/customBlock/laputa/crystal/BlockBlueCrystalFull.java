...
public class BlockBlueCrystalFull extends BlockCrystalFullBase {

	public BlockBlueCrystalFull() {
		super("laputa_blue", Material.GLASS, 2, 2, "pickaxe", 0, SoundType.GLASS, 0.3F);
	}
