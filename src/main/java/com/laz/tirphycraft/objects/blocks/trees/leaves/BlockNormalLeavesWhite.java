...
public class BlockNormalLeavesWhite extends BlockLeaves implements IHasModel {
	public static String type;

	public BlockNormalLeavesWhite(String name) {
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (rand.nextInt(30) == 0) {
			if (worldIn.getBlockState(pos.down()) == Blocks.AIR.getDefaultState()) {
				...
				Reference.PROXY.spawnParticle(worldIn, ParticleTypes.FALLING_LEAF, pos.getX() + x, pos.getY(),
						pos.getZ() + z, 0.05f, -0.1f, 0, 0.913f, 0.905f, 0.909f);
			}
		}
	}
}