package com.laz.tirphycraft.dimension.Gosyn;
...
public class BiomeProviderGosyn extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderGosyn() {
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderGosyn(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerFixGosyn.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderGosyn(World world) {
		this(world.getSeed());
	}
