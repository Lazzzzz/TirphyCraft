...
public class BiomeProviderLaputa extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderLaputa() {
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderLaputa(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerFixLaputa.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderLaputa(World world) {
		this(world.getSeed());
	}
