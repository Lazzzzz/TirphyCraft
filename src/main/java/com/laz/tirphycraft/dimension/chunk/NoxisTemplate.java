...
import com.laz.tirphycraft.dimension.chunk.cave.NoxisCaveGen;
...
public class NoxisTemplate implements IChunkGenerator
{
    /** RNG. */
    private final Random rand;
    protected static final IBlockState OBSIDIAN = BlockInit.NOXIS_STONE.getDefaultState();
    ...
    public NoxisTemplate(World p_i47241_1_, boolean p_i47241_2_, long p_i47241_3_, BlockPos p_i47241_5_)
    {
		...
		caveGenerator = net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(new NoxisCaveGen(),
    ...
    public void buildSurfaces(ChunkPrimer primer)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            for (int j = 0; j < 16; ++j)
            {
                int k = 1;
                int l = -1;
                IBlockState iblockstate = OBSIDIAN;
                IBlockState iblockstate1 = OBSIDIAN;
