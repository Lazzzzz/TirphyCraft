...
public class WorldGenNormalGoldirTree extends WorldGenAbstractTree {
	public static final IBlockState LOG = BlockInit.LOG_GOLDIR.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_GOLDIR.getDefaultState();

	private final int minHeight;

	public WorldGenNormalGoldirTree() {
		super(false);
		this.minHeight = 10;
	}
