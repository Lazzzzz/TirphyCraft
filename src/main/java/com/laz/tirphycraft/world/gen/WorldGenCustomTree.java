...
{
	private final WorldGenerator NORMAL_COPPIR = new WorldGenNormalCoppirTree();
	private final WorldGenerator NORMAL_SILVIR = new WorldGenNormalSilvirTree();
	private final WorldGenerator NORMAL_GOLDIR = new WorldGenNormalGoldirTree();	
