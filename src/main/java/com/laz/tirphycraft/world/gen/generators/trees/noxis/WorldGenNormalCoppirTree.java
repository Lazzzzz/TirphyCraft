package com.laz.tirphycraft.world.gen.generators.trees.noxis;
...
public class WorldGenNormalCoppirTree extends WorldGenAbstractTree {
	public static final IBlockState LOG = BlockInit.LOG_COPPIR.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_COPPIR.getDefaultState();

	private final int minHeight;

	public WorldGenNormalCoppirTree() {
		super(false);
		this.minHeight = 6;
	}
