...
public class WorldGenNormalSilvirTree extends WorldGenAbstractTree {
	public static final IBlockState LOG = BlockInit.LOG_SILVIR.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_SILVIR.getDefaultState();

	private final int minHeight;

	public WorldGenNormalSilvirTree() {
		super(false);
		this.minHeight = 8;
	}
