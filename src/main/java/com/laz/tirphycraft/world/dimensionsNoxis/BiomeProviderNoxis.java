package com.laz.tirphycraft.world.dimensionsNoxis;
...
public class BiomeProviderNoxis extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderNoxis() {
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderNoxis(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerFixNoxis.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderNoxis(World world) {
		this(world.getSeed());
	}
