...
public class FrozTemplate implements IChunkGenerator {
	...
	protected static final IBlockState STONE = BlockInit.FROZ_STONE.getDefaultState();
	protected static final IBlockState GRAVEL = BlockInit.FROZ_STONE.getDefaultState();
