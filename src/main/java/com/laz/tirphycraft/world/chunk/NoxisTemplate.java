package com.laz.tirphycraft.world.chunk;

import java.util.List;
import java.util.Random;

import com.laz.tirphycraft.init.BlockInit;
import com.laz.tirphycraft.world.chunk.cave.NoxisCaveGen;
...
public class NoxisTemplate implements IChunkGenerator {
	...
	protected static final IBlockState STONE = BlockInit.NOXIS_STONE.getDefaultState();
	protected static final IBlockState GRAVEL = BlockInit.NOXIS_STONE.getDefaultState();
	...
	public NoxisTemplate(World worldIn, long seed) {
