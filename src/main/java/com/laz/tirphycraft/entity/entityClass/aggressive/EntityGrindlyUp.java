...
public class EntityGrindlyUp extends EntityMob {
	public EntityGrindlyUp(World worldIn) {
	...
	protected ResourceLocation getLootTable() {
		return LootTableHandler.GRINDLYUP_LOOT;
	}
	...
	public boolean attackEntityAsMob(Entity entityIn) {
		...
		entityIn.motionX = 0.5D * view.x;	
		entityIn.motionY = 1.5D;
		entityIn.motionZ = 0.5D * view.z;			
