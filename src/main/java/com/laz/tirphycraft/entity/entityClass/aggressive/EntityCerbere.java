...
public class EntityCerbere extends EntityMob {
	public EntityCerbere(World worldIn) {
	...
	public void onUpdate() {
		if(this.getAttackTarget() != null) this.world.setBlockState(new BlockPos(this.posX,  this.posY, this.posZ), Blocks.FIRE.getDefaultState());
		super.onUpdate();
	}
