...
public class BlockYellowCrystalFull extends BlockCrystalFullBase {

	public BlockYellowCrystalFull() {
		super("laputa_yellow", Material.GLASS, 2, 2, "pickaxe", 0, SoundType.GLASS, 0.3F);
	}
	...
	private void spawnParticles(World worldIn, BlockPos pos) {
		...
		if (random.nextInt(3) == 0) {
			...
			Reference.PROXY.spawnParticle(worldIn, ParticleTypes.GLINT_YELLOW, d0, d1, d2, 0.0D, 0.1D, 0.0D);
		}
	}
