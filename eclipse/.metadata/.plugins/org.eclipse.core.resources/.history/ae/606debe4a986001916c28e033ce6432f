...
public class EntityPrimaryHeal extends EntityMob {
	...
	public boolean hitByEntity(Entity entityIn) {
		if (this.entityTarget != null) {
			this.entityTarget.heal_is_attack = true;
		}
		this.cooldown = 10 * 20;
	...
	public void getAndStrengthTarget() {
	...
	public void beam() {
		if (this.entityTarget != null) {
			...
			Reference.PROXY.spawnParticle(this.world, ParticleTypes.GLINT_BOSS_PURPLE, x, y, z, -dir.x, -dir.y, -dir.z);
