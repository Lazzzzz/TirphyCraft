...
public class BlockGreenCrystal extends BlockCrystalBase {

	public BlockGreenCrystal() {
		super("laputa_green_crystal");
	}
	...
	private void spawnParticles(World worldIn, BlockPos pos) {
		...
		if (random.nextInt(3) == 0) {
			...
			Reference.PROXY.spawnParticle(worldIn, ParticleTypes.GLINT_GREEN, d0, d1, d2, 0.0D, 0.1D, 0.0D);
		}
	}
}
